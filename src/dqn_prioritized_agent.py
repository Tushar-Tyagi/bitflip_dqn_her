...
from prioritized_buffer_base import PrioritizedReplayBuffer
...
class DQNPrioritizedAgent:
    ...
    - Uses PrioritizedReplayBuffer instead of ReplayBuffer
    - Applies importance sampling weights to loss
    - Updates transition priorities after each training step
    """
    ...
    def __init__(self,
                 ...
                 device: str = 'cpu'):
        """
        Initialize DQN agent with prioritized replay.
        ...
        Args:
            ...
            priority_strategy: Strategy for computing priorities ('td_error', 'policy_loss', etc.)
    ...
    def update(self) -> Dict[str, float]:
        """
        Perform one update step with prioritized replay.
